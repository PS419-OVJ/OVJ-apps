...
Dalam membuat **REST API** kami menggunakan Node.js dan Framework Express.js, untuk respons menggunakan format **JSON**. Untuk masing-masing URL yang dapat digunakan akan dijelaskan dibawah ini.
